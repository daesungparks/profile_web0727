					...
					<table border="0" cellspacing="0" cellpadding="10">
						<form action ="infomodifyOk" method="post" name="join_form">
							...
							<tr>
								...
								<td><input class="input_box1"type="password" name="mpw" value="${memberDto.mpw }"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input class="input_box1" type="text" name="mname" value="${memberDto.mname}"></td>
							</tr>
							<tr>
								<td><span class="content_text" >EMAIL :</span></td>
								<td><input class="input_box1" type="text" name="memail" value="${memberDto.memail }"></td>
							</tr>
							<tr>
								<td><span class="content_text" >JOINDATE:</span></td>
								<td><input class="input_box1" type="text" name="mdate" value="${memberDto.mdate }" readonly></td>
							</tr>
							<tr>
